        ...
        <div>
            ...
            >
                <div className="flex max-w-[90vw] mx-auto justify-between items-center relative">
                    ...
                    <div
                        ref={menuRef}
                        className={`fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform transform ${open ? 'translate-x-0' : 'translate-x-full'} w-80 bg-secondary-950`}
                        tabIndex="-1"
