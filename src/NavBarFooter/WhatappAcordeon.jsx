...
export function WhatappAcordeon({ children }) {
    ...
    return (
        <div className="relative">
            <button
                className="flex justify-between uppercase items-center text-white font-poppins text-left"
            ...
            <div
                ...
                onMouseOver={() => setIsOpen(true)}
                onMouseOut={() => setIsOpen(false)}
                className="z-30 absolute translate-x-[-100px] translate-y-2 bg-secondary-950  transition-max-height duration-100 ease-in-out overflow-hidden pl-4 pr-4 rounded"
            >
